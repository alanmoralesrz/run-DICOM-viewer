...
from vtkmodules.vtkRenderingCore import vtkTextProperty, vtkTextMapper, vtkActor2D
...
# Initialize DICOM viewer class here
if sys.argv[1] == 'python_script':
    dicom_folder_path = r'C:\Users\Dario 24\OneDrive\Documentos\Nuevo Orden\Escuela\Carrera IB\9 semestre\Tele\dcm_view_t2\PAT034'
    viewer = DICOMViewer(dicom_folder=dicom_folder_path, view_orientation='sagittal')
    viewer.render()  # This launches the VTK window for viewing the DICOM files
